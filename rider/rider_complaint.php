...
<!--body-->
    ...
    $query = "SELECT * FROM complaint JOIN orderlist ON complaint.order_id=orderlist.order_id WHERE orderlist.rider_id = '$riderid' ORDER BY `complaint_id` DESC;";
