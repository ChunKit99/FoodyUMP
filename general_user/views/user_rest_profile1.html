        ...
        <div class="page-main-content">
            ...
            <div class="menu">
                ...
                <div class="restaurant">
                    ...
                    <br><br>
                    <a href="user_malay.html"><button class="menubutton" class="btn btn-info btn-lg">MENU</button></a>
                    <a href="user_home.html"><button class="backbutton" class="btn btn-info btn-lg">BACK</button></a>
                </div>
            </div>
        </div>
