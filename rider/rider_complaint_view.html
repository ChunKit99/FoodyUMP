    ...
    <body>
        ...
        <div id="nav-container">
            <div class="container-width nav-container">
                ...
                <a href="rider_complaint.html" class="" style="background: #11767ca6;">Complaint</a>
            </div>
        </div>
        <!--content-->
        <div id="page-content">
            <div class="page-main-content">
                <!--title-->
                <h1>View Complaint From User</h1>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-row align-items-center">
                                        <div class="col-auto my-1">
                                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                                <option Disabled >Choose...</option>
                                                <option Disabled selected value="1">Late Delivery</option>
                                                <option Disabled value="2">Damaged Food</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" id="discriptionComplaint" readonly></textarea>
                                </div>
                            </div>
                            <!--status complaint-->
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-row align-items-center">
                                        <div class="col-auto my-1">
                                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                                <option disabled>Choose...</option>
                                                <option disabled value="1">In Investigation</option>
                                                <option disabled selected value="2">Resolved</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!--button back-->
                            <div class="btn-group fr" role="group" aria-label="cancel button">
                                <a href="rider_complaint.html"><button type="button" class="btn btn-secondary">Back</button></a>
                            </div>
